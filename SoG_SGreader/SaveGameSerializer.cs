...
namespace SoG_SGreader
{
    ...
    {
        public static Player Deserialize(string fileName, ITextBoxWrapper txtConsole)
        {
            // Code copied from former DataReader.ReadFromFile
        ...
        {
            // Code copied from former DataReader.GetPlayerPreview()
            string nickname = "";
            bool sex = false;
            try {
                using FileStream fileStream = new FileStream(fileName, FileMode.Open);
        ...
        public static World DeserializeWorld(string fileName, ITextBoxWrapper txtConsole)
        {
        ...
        public static void Serialize(Player playerObject, string fileName)
        {
            // Code copied from former DataWriter.WriteToFile but converted to static method
